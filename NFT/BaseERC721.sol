...
contract BaseERC721 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            /**code*/ msg.sender == owner || _operatorApprovals[owner][msg.sender] == true,
    ...
    function _isApprovedOrOwner(
        ...
        return _owners[tokenId] == spender || _tokenApprovals[tokenId] == spender ||  _operatorApprovals[_owners[tokenId]][spender] == true; 
        /**code*/
    }
